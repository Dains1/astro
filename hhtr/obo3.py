...
async def get_response2(message_text):
    prompt = {
        ...
        "messages": [
            {
                "role": "system",
                "text": "Ты - рассказчик, рассказываешь истории на любую тему, но не превышающие 20 предложений и не болеел "
            },
            {
                "role": "user",
                "text": message_text
...
async def get_response3(message_text):
    prompt = {
        ...
        "messages": [
            {
                "role": "system",
                "text": "Ты - помогаешь людям находить по их предпочтениям игры, аниме и сериалы 20 предложений"
            },
            {
                "role": "user",
                "text": message_text
